...
# Based on CATS-RCF Implementation and Modification @ https://github.com/WHUHLX/CATS
class Network(nn.Module):
    def __init__(self):
        super(Network, self).__init__()

        # Coordinate Attention Mechanism
        self.Coord_attention = CoordAtt(3, 3)
    ...
    def forward(self, x):
        ...
        # Add the coordinate attention mechanism
...
# Based on CoordAttention Implementation @ https://github.com/Andrew-Qibin/CoordAttention
